...
export function MapPreview({
  ...
  return (
    <div className="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#2A201D] p-1 shadow-sm">
      <div className="w-full h-48 md:h-64 lg:h-75 rounded-lg bg-gray-200 dark:bg-gray-700 relative overflow-hidden">
        <iframe
        ...
        >
          <span className="px-4 md:px-5 py-2 md:py-2.5 bg-white text-black text-xs md:text-sm font-bold rounded-full shadow-lg group-hover:scale-105 transition-transform flex items-center gap-1.5 md:gap-2">
      ...
      <div className="p-2.5 md:p-3 flex justify-between items-center">
        <div>
          ...
          <p className="text-xs md:text-sm font-semibold mt-0.5 text-gray-900 dark:text-white">
