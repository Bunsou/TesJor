  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-0 bottom-0 left-0 p-4 cursor-pointer transition-colors duration-100 z-10"
        aria-label="View Previous Trending Destination"
      >
        <div className="bg-background/95 p-2 rounded-full">
          <ChevronLeft className="w-6 h-6 text-primary/90" aria-hidden />
        </div>
      </button>
      ...
      <button
        ...
        className="absolute top-0 bottom-0 right-0 p-4 cursor-pointer transition-colors duration-100 z-10"
        aria-label="View Next Trending Destination"
      >
        <div className="bg-background/95 p-2 rounded-full">
          <ChevronRight className="w-6 h-6 text-primary/90" aria-hidden />
        </div>
      </button>
