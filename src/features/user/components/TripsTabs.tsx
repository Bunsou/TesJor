...
export function TripsTabs({ activeTab, onTabChange }: TripsTabsProps) {
  return (
    <div className="border-b border-gray-200 dark:border-gray-800">
      <nav aria-label="Tabs" className="flex gap-6 md:gap-8">
        <button
          onClick={() => onTabChange("bookmarked")}
          className={`border-b-2 py-3 md:py-4 px-1 text-sm md:text-base font-semibold transition-colors min-h-[48px] flex items-center ${
